...
import { Filter, CirclePlus as PlusCircle, Search } from 'lucide-react-native';
...
export default function CoursesScreen() {
  ...
  const filteredCourses = courses.filter(course => {
    ...
    return matchesSearch && course.department === selectedFilter;
  });
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#111827' : '#F9FAFB' }]}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <CourseCard course={item} isDark={isDark} />
        )}
